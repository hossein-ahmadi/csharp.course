...
namespace Demo132___EFCoreTransactions.DbModel;
...
public class BlogDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        blogEntity.HasData(new List<Blog>()
        {
        ...
        blogEntity.Property(e => e.Url).HasMaxLength(50);
        blogEntity.HasIndex(blog => blog.Url).IsUnique();
